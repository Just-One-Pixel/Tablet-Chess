...
public class Brett extends JPanel {
	...
	public void openFigurAuswahl(boolean istWeiß, int reihe, int spalte) {
		...
		ImageIcon laeufer;
		if(istWeiß) {
			dame = new ImageIcon("src/figuren/bilder/WDame.png");
			springer = new ImageIcon("src/figuren/bilder/WSpringer.png");
			laeufer = new ImageIcon("src/figuren/bilder/WLaeufer.png");
			turm = new ImageIcon("src/figuren/bilder/WTurm.png");
			vorzeichen = 1;
		}
		else {
			dame = new ImageIcon("src/figuren/bilder/SDame.png");
			springer = new ImageIcon("src/figuren/bilder/SSpringer.png");
			laeufer = new ImageIcon("src/figuren/bilder/SLaeufer.png");
			turm = new ImageIcon("src/figuren/bilder/STurm.png");
			vorzeichen = -1;
		}
		//1Feld
